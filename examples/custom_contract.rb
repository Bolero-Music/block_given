...
class CatalogMarket < UncleBlockGiven::Contract
  abi_file File.expand_path("../artifacts/CatalogMarket.json", __dir__) # Hardhat artifact ({ "abi": [...] })
  address "0x0000000000000000000000000000000000000001"
end

wallet = UncleBlockGiven::Wallet.new(private_key: ENV.fetch("PRIVATE_KEY"))
...
# Dry-run before paying gas: raises UncleBlockGiven::ContractRevertError with the decoded custom error on failure
begin
