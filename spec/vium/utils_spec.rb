...
RSpec.describe Vium::Utils do
  describe ".parse_units / .format_units" do
    ...
    it "rejects values with too many decimals" do
      expect { described_class.parse_units("1.0000001", 6) }.to raise_error(Vium::InvalidArgumentError)
    end
  ...
  describe "hex helpers" do
    ...
    it "builds block tags" do
      ...
      expect { described_class.block_tag("yesterday") }.to raise_error(Vium::InvalidArgumentError)
    end
  end
  ...
  describe ".checksum_address" do
    it "checksums and validates" do
      ...
      expect { described_class.checksum_address("0x123") }.to raise_error(Vium::InvalidAddressError)
    end
