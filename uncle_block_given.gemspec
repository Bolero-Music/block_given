...
require_relative "lib/uncle_block_given/version"

Gem::Specification.new do |spec|
  spec.name = "uncle_block_given"
  spec.version = UncleBlockGiven::VERSION
  ...
  spec.description = <<~DESC
    UncleBlockGiven lets you talk to EVM smart contracts from Ruby with a small, explicit API
  ...
  DESC
  spec.homepage = "https://github.com/Bolero-Music/uncle_block_given"
  spec.license = "MIT"
  ...
  spec.metadata["documentation_uri"] = "https://rubydoc.info/gems/uncle_block_given"
