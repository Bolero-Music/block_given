...
- `UncleBlockGiven::Contract`: typed contract classes from an ABI file (`abi_file`, `UncleBlockGiven.config.abi_path`), snake_case
...
- Watcher registry: unique ids, `UncleBlockGiven.watchers`, `UncleBlockGiven::Watcher.find / stop / kill / stop_all`, named threads,
  diagnostics (`to_h`).
...
[Unreleased]: https://github.com/Bolero-Music/uncle_block_given/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/Bolero-Music/uncle_block_given/releases/tag/v0.1.0
