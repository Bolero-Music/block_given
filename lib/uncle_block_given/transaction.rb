...
module UncleBlockGiven
  ...
  #   tx.hash            # => "0x..."
  #   receipt = tx.wait  # polls until mined (see UncleBlockGiven.config.timeout / polling_interval)
  #   tx.wait!           # same, but raises UncleBlockGiven::TransactionRevertedError on failure
  class Transaction
    ...
    def inspect = "#<UncleBlockGiven::Transaction #{hash}#{mined_flag}>"
