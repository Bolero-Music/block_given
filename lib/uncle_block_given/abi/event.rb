...
module UncleBlockGiven
  module Abi
    class Event
      ...
      # Decodes a normalized log (Hash with :topics and :data) into a UncleBlockGiven::Event.
      def decode(log)
        ...
        UncleBlockGiven::Event.new(name: name, signature: signature, args: ordered, log: log)
      end
      ...
      def to_s = signature
      def inspect = "#<UncleBlockGiven::Abi::Event #{signature}>"
